...
echo ""
echo "═══════════════════════════════════════════════════"
echo "  Arnaud Work devcontainer — environment test"
echo "═══════════════════════════════════════════════════"
...
if git ls-remote "https://github.com/arnaud-work/website.git" HEAD >/dev/null 2>&1; then
  ok "git — read access to arnaud-work/website"
else
...
if [ -n "${GH_TOKEN:-}" ]; then
  ...
  fail "GH_TOKEN — missing (export GH_TOKEN_FOR_ARNAUD_WORK on the host before reopening)"
fi
